 ...
 *
 */
#define DEFAULT_LCD_BRIGHTNESS      6  // 10: LCD_100_PERCENT - Brightness value from list
 ...
 */
#define ST7920_BANNER_TEXT "SecKit SK-GO 350"
...
//                         PLA      PETG      Nylon
#define PREHEAT_LABELS   {"PLA",   "PETG",   "Nylon"}
#define PREHEAT_BED      {60,      70,       80}
#define PREHEAT_HOTEND   {200,     245,      260}
...
#define NOZZLE_RESUME_PURGE_LENGTH  10   // (mm)
